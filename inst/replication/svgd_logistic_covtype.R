...
##
## Data note:
## The package ships a 5,000-row preprocessed Covertype excerpt for a
## CRAN-sized replication run. The complete LIBSVM Covertype data source is:
## https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/binary/covtype.libsvm.binary.scale.bz2
## The dense RDS file used below is derived from that LIBSVM source.
