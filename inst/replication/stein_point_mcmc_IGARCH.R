...
##
## Data note:
## The package ships the small S&P 500 MATLAB data file used by this
## CRAN-sized replication run. The upstream data source is:
## https://raw.githubusercontent.com/wilson-ye-chen/sp-mcmc/master/src/lib/data_spx.mat
